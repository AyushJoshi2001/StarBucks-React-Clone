...
function Footer(props) {
  return (
    <>
      <hr className="border border-gray-300 mt-14" />
      <div className="px-4 py-14 xl:px-10 max-w-1440 xl:mx-auto">
        <div className="space-y-10 xl:flex xl:space-y-0">
          <div className="flex flex-1 xl:flex-col xl:space-y-5">
            <FooterLink>About Us</FooterLink>
            <div class="hidden text-gray-600 xl:block ">
              <ul class="space-y-5 md:text-lg">
                <li class="hover:text-black">
                  <a href="http://google.com"> Our Heritage </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Our Coffee </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Stories and News </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Investor Relations </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Policies and Standards </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Customer Service </a>
                </li>
              </ul>
            </div>
          </div>
          <div className="flex flex-1 xl:flex-col xl:pl-8 xl:space-y-5">
            <FooterLink>Careers</FooterLink>
            <div class="hidden text-gray-600 xl:block">
              <ul class="space-y-5 md:text-lg">
                <li class="hover:text-black">
                  <a href="http://google.com"> Culture and Values </a>
                </li>
                <li class="hover:text-black">
                ...
                <li class="hover:text-black">
                  <a href="http://google.com"> College Achievement Plan </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> U.S. Careers </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> International Careers </a>
                </li>
              </ul>
            </div>
          </div>
          <div className="flex flex-1 xl:flex-col xl:pl-8 xl:space-y-5">
            ...
            <div class="hidden text-gray-600 xl:block">
              <ul class="space-y-5 md:text-lg">
                <li class="hover:text-black">
                  <a href="http://google.com"> Ethical Sourcing </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Leading in Sustainability </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Strengthening Communities </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Creating Opportunities </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Global Social Impact Report </a>
                </li>
              </ul>
            </div>
          </div>
          <div className="flex flex-1 xl:flex-col xl:pl-8 xl:space-y-5">
            <FooterLink>For Business Partners</FooterLink>
            <div class="hidden text-gray-600 xl:block">
              <ul class="space-y-5 md:text-lg">
                <li class="hover:text-black">
                  <a href="http://google.com"> Landlord Support Center </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Suppliers </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Corporate Gift Card Sales </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com">
          ...
          <div className="flex flex-1 xl:flex-col xl:pl-8 xl:space-y-5">
            <FooterLink>Order and Pickup</FooterLink>
            <div class="hidden text-gray-600 xl:block">
              <ul class="space-y-5 md:text-lg">
                <li class="hover:text-black">
                  <a href="http://google.com"> Order on the App </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Order on the Web </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Delivery </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com"> Order and Pickup Options </a>
                </li>
                <li class="hover:text-black">
                  <a href="http://google.com">
        ...
        <div className="mt-10 space-x-1">
          <SocialmediaLogo link="http://google.com">
            <svg
              viewBox="0 0 24 24"
              className="w-9 h-9 valign-middle absoluteCenter"
          ...
          <SocialmediaLogo link="http://google.com">
            <svg
              viewBox="0 0 24 24"
              className="h-9 w-9 valign-middle absoluteCenter"
              preserveAspectRatio="xMidYMid meet"
              aria-hidden="true"
              focusable="false"
            >
          ...
          <SocialmediaLogo link="http:google.com">
            <svg
              viewBox="0 0 24 24"
              className="h-9 w-9valign-middle absoluteCenter"
              preserveAspectRatio="xMidYMid meet"
              aria-hidden="true"
              focusable="false"
            >
        ...
        <ul className="inline-block py-10 space-y-5 xl:py-7 md:text-lg xl:flex xl:space-y-0 xl:space-x-7">
          ...
          <li className="hidden xl:block">|</li>
          <li className="hover:underline">
            <a href="http://google.com">CA Supply Chain Act</a>
          </li>
          <li className="hidden xl:block">|</li>
          <li className="hover:underline">
            <a href="http://google.com">Submit Your Idea</a>
          </li>
          <li className="hidden xl:block">|</li>
          <li className="hover:underline">
            <a href="http://google.com">Cookie Preferences</a>
          </li>
        </ul>
